...
Elm.Main.make = function (_elm) {
   ...
   var viewAssignment = F2(function (address,assignment) {
      ...
      _U.list([A2($Html.td,
              ...
              _U.list([$Html$Attributes.value(assignment.grade)
                      ,A3($Html$Events.on,
                      "input",
              ...
              _U.list([]),
              _U.list([A2($Html.input,
              _U.list([$Html$Attributes.value(assignment.weight)
                      ,A3($Html$Events.on,
                      "input",
                      $Html$Events.targetValue,
                      function (_p1) {
   ...
   var NoOp = {ctor: "NoOp"};
   var newAssignment = function (id) {    return {grade: "0.0",weight: "0.0",id: id};};
   var emptyModel = {assignments: _U.list([newAssignment(1)]),uid: 2,currentGrade: 0.0,completedGrade: 0.0};
   var update = F2(function (action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "NoOp": return model;
         case "Add": return _U.update(model,{uid: model.uid + 1,assignments: A2($Basics._op["++"],model.assignments,_U.list([newAssignment(model.uid)]))});
         case "Delete": return _U.update(model,{assignments: A2($List.filter,function (a) {    return !_U.eq(a.id,_p2._0);},model.assignments)});
         case "Calculate": var toFloat = function (num) {
              var _p3 = $String.toFloat(num);
              if (_p3.ctor === "Err") {
                    return 0.0;
                 } else {
                    return _p3._0;
           ...
           var calculateSum = F2(function (assignment,sum) {    return sum + toFloat(assignment.grade) / 100 * toFloat(assignment.weight);});
           return _U.update(model,
           {currentGrade: A3($List.foldr,calculateSum,0.0,model.assignments) / model.completedGrade * 100
           ,completedGrade: A3($List.foldr,F2(function (a,sum) {    return sum + toFloat(a.weight);}),0.0,model.assignments)});
         case "UpdateGrade": var updateGrade = function (a) {    return _U.eq(a.id,_p2._0) ? _U.update(a,{grade: _p2._1}) : a;};
           return _U.update(model,{assignments: A2($List.map,updateGrade,model.assignments)});
         default: var updateWeight = function (a) {    return _U.eq(a.id,_p2._0) ? _U.update(a,{weight: _p2._1}) : a;};
   ...
   var Model = F4(function (a,b,c,d) {    return {assignments: a,uid: b,currentGrade: c,completedGrade: d};});
